<template>
    ...
    <div class="banner" @click="bannerClick">
        ...
        <div class="banner-info">
            <div class="banner-title">东湖海洋世界(AAA景区)</div>
...
export default {
    ...
    data(){
        return {
            showGallary: false,
            imgs: ['http://img1.qunarzz.com/sight/p0/201404/23/04b92c99462687fa1ba45c1b5ba4ad77.jpg_800x800_70debc93.jpg','http://img1.qunarzz.com/sight/p0/1501/f4/f41761361d6c8893.water.jpg_r_800x800_a8cb0a6b.jpg']
        }
    },
    components: {
        CommonGallary
